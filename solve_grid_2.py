...
# known-good reference pose, same one used in solve_grid_1.py
GOOD_REFERENCE = [-2.844, -1.449, -1.854, -1.410, 1.571, -1.273]
...
FINGER_LENGTH = 0.15748  # 6.2 inches
HOVER_Z = 0.30
PROBE_Z = 0.00
DESCENT_STEPS = 6
MAX_JOINT_JUMP = 1.0
...
reference = solve(CENTER_X, CENTER_Y, HOVER_Z, GOOD_REFERENCE, max_jump=10.0)
